...
conv1 = tf.keras.layers.Conv2D(128,(3,3),padding='same',activation='relu')(Input_Layer)
...
##### CAM Module
#CAM_Module_1 = CAM_Module_1(pt_model_op)

##### Output Module
GAP_op = tf.keras.layers.GlobalAveragePooling2D()(SC_Conv33)
